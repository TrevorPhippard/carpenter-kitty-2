...
const (
	UserService_Ping_FullMethodName = "/gateway.UserService/Ping"
)
...
//
// This service mirrors UserService for gateway use.
// We provide a simple Ping RPC so GraphQL can test connectivity.
