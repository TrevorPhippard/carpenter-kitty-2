    ...
    experiences: [
      {
        ...
        description: "Cattus accommodo votum. Corporis cicuta arguo attero.",
      ...
      },
      {
        ...
        description: "Quia victus trans. Bis asperiores strenuus claro patria.",
        technologies: ["GraphQL", "Vue", "TypeScript"],
        achievements: ["Improved performance", "Delivered ahead of schedule"],
      },
    ],
    education: [
      {
