...
type ComplexityRoot struct {
	Mutation struct {
		...
		DeletePerson func(childComplexity int, name string) int
		UpdatePerson func(childComplexity int, old string, new string) int
	}
...
type MutationResolver interface {
	...
	UpdatePerson(ctx context.Context, old string, new string) (*Person, error)
	DeletePerson(ctx context.Context, name string) (bool, error)
}
type QueryResolver interface {
	Persons(ctx context.Context) ([]*Person, error)
}
...
func (e *executableSchema) Complexity(ctx context.Context, typeName, field string, childComplexity int, rawArgs map[string]any) (int, bool) {
	...
	case "Mutation.deletePerson":
		...
		return e.complexity.Mutation.DeletePerson(childComplexity, args["name"].(string)), true
	case "Mutation.updatePerson":
		...
		return e.complexity.Mutation.UpdatePerson(childComplexity, args["old"].(string), args["new"].(string)), true
...
func (ec *executionContext) _Mutation_createPerson(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		...
		ec.OperationContext,
		field,
		ec.fieldContext_Mutation_createPerson,
		func(ctx context.Context) (any, error) {
			fc := graphql.GetFieldContext(ctx)
			return ec.resolvers.Mutation().CreatePerson(ctx, fc.Args["name"].(string))
		},
		nil,
		ec.marshalNPerson2ᚖconnectionsᚋinternalᚋgraphᚐPerson,
		true,
		true,
	)
}
...
func (ec *executionContext) _Mutation_updatePerson(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		...
		ec.OperationContext,
		field,
		ec.fieldContext_Mutation_updatePerson,
		func(ctx context.Context) (any, error) {
			fc := graphql.GetFieldContext(ctx)
			return ec.resolvers.Mutation().UpdatePerson(ctx, fc.Args["old"].(string), fc.Args["new"].(string))
		},
		nil,
		ec.marshalNPerson2ᚖconnectionsᚋinternalᚋgraphᚐPerson,
		true,
...
func (ec *executionContext) _Mutation_deletePerson(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		...
		ec.OperationContext,
		field,
		ec.fieldContext_Mutation_deletePerson,
		func(ctx context.Context) (any, error) {
			fc := graphql.GetFieldContext(ctx)
			return ec.resolvers.Mutation().DeletePerson(ctx, fc.Args["name"].(string))
		},
		nil,
...
func (ec *executionContext) _Query_persons(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		...
		ec.OperationContext,
		field,
		ec.fieldContext_Query_persons,
		func(ctx context.Context) (any, error) {
			return ec.resolvers.Query().Persons(ctx)
		},
		nil,
		ec.marshalNPerson2ᚕᚖconnectionsᚋinternalᚋgraphᚐPersonᚄ,
		true,
		true,
	)
}
...
func (ec *executionContext) marshalNPerson2connectionsᚋinternalᚋgraphᚐPerson(ctx context.Context, sel ast.SelectionSet, v Person) graphql.Marshaler {
	return ec._Person(ctx, sel, &v)
}

func (ec *executionContext) marshalNPerson2ᚕᚖconnectionsᚋinternalᚋgraphᚐPersonᚄ(ctx context.Context, sel ast.SelectionSet, v []*Person) graphql.Marshaler {
	...
	for i := range v {
		...
		f := func(i int) {
			...
			ret[i] = ec.marshalNPerson2ᚖconnectionsᚋinternalᚋgraphᚐPerson(ctx, sel, v[i])
		}
		if isLen1 {
			f(i)
		} else {
...
func (ec *executionContext) marshalNPerson2ᚖconnectionsᚋinternalᚋgraphᚐPerson(ctx context.Context, sel ast.SelectionSet, v *Person) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			ec.Errorf(ctx, "the requested element is null which the schema does not allow")
		}
